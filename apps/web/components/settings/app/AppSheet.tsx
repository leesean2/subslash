  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex h-[100dvh] items-end">
      ...
      <div
        ...
        aria-modal="true"
        aria-label={label}
        className="relative flex max-h-[85dvh] w-full flex-col rounded-t-3xl border-t bg-background shadow-2xl animate-in slide-in-from-bottom-8 fade-in"
      >
